...
export default defineComponent({
  ...
  computed: {
    getDevelopmentCategories() {
      return this.categoryList.categories.filter((elem) => elem.category === 'Development')
    }
  }
})
</script>
...
<template>
  <div class="card-container">
    <div className="card" v-for="category in getDevelopmentCategories" :key="category.id">
